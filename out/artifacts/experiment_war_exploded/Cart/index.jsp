...
<div align="center">
    ...
    <form action="order.jsp" method="post">
        <table style="border:1px solid green;" cellpadding="0" border="1" align="center">
            ...
            <tr>
                <td>2</td>
                <td><img src="${pageContext.request.contextPath}/images/pencil case.jpg" height="100" width="100"/>文具盒</td>
                <td>￥10.0</td>
                <td><input type="text" name="pencil case" id="2" placeholder="0"></td>
            </tr>
            <tr>
                <td>3</td>
                <td><img src="${pageContext.request.contextPath}/images/scratch paper.jpg" height="100" width="100"/>草稿纸</td>
                <td>￥2.0</td>
                <td><input type="text" name="scratch paper" id="3" placeholder="0"></td>
            </tr>
            <tr>
                <td>4</td>
                <td><img src="${pageContext.request.contextPath}/images/packaging tape.jpg" height="100" width="100"/>胶带</td>
                <td>￥2.5</td>
...
>>>>>>> 1a839c038ae531e2ef0459ebd7a9479ba0c7842e
</body>
</html>